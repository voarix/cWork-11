      ...
      {loading ? (
        ...
        >
          ...
          <div className="mt-6 flex items-center justify-end gap-x-4">
            ...
            <button
              type="submit"
              className="rounded-md cursor-pointer border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
            >
              Save
            </button>
          </div>
